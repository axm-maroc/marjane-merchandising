...
## Correction d'erreur API
- [x] Corriger l'erreur de requête sur /stores (ID 30030 inexistant)
- [x] Ajouter une gestion d'erreur robuste pour les magasins inexistants
- [x] Ajouter l'option enabled pour éviter les requêtes avec IDs invalides
- [x] Vérifier que la page /stores fonctionne correctement
