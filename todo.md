...
## Correction des photos dans l'Éditeur Interactif
- [x] Vérifier pourquoi les photos ne s'affichent pas dans PlanogramCanvas
- [x] Ajouter image par défaut si photoUrl est vide
- [x] Ajouter gestion d'erreur pour les images manquantes
- [x] Tester l'affichage dans l'éditeur interactif
- [x] Vérifier que tous les tests passent (101/105)
